...
<div class="body">
	...
	<div id="tx_canvas" class="tx-canvas">
		...
		<div class="tx-source-deco">
			<div id="tx_canvas_source_holder" class="tx-holder">
				<textarea id="tx_canvas_source" rows="30" cols="30">11111111</textarea>
			</div>
		</div>
		<div id="tx_canvas_text_holder" class="tx-holder">
			<textarea id="tx_canvas_text" rows="30" cols="30">2222222222</textarea>
		</div>
	</div>
					<!-- 높이조절 Start -->
  ...
  <tr>
  	<td colspan="2" align="right">
  		<input type="submit" onclick='saveContent()' value="수정">
  	</td>
  </tr>
  </table>
  </form>
