...
<link href="${initParam.root }post/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all" />
<!-- 부트스트랩 -->
...
<body>
 <div style="
      background-image: url(${initParam.root }img/post_qna_board.jpg); 
      width: 100%; height: 300px; background-repeat: no-repeat;" align="center">
  ...
  <p style="font-weight: bold; font-size: 25px; margin-top: 5%;">웨딩 QnA</p>
</div>
