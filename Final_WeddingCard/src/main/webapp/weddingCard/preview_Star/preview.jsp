...
.header-top {
	...
	.backg_select {
     background: url(${initParam.root}url/temp_${sessionScope.mvo.memberId}/${param.imgSrc}) center top / cover no-repeat;
	 background-size:cover;
	 min-height: 380px;
	}
#kakao-link-btn img
	...
	background-size:cover;
		...
		.backg_select {
		     background: url(${initParam.root}url/temp_${sessionScope.mvo.memberId}/${param.imgSrc}) no-repeat -420px 0px;
			background-size:cover;
			min-height: 380px;
		}
	...
	.portfolio-text
{
	...
	.backg_select {
	    background: url(/Final_WeddingCard/url/temp_${sessionScope.mvo.memberId}/${param.imgSrc}) no-repeat -100px 0px;
	    background-size: cover;
	    min-height: 340px;
	}
		...
		.contact-form, .address-space
{
	...
	@media (min-width: 380px) and (max-width: 1300px) {
		.backg_select {
    background: url(/Final_WeddingCard/url/temp_${sessionScope.mvo.memberId}/${param.imgSrc}) center top / cover no-repeat;
    background-size: cover;
    min-height: 440px;
	}
