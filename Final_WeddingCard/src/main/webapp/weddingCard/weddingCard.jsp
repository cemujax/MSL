...
<!-- 메뉴바 -->
		<div class="navigation" >
				<nav class="navbar navbar-default" >
					...
					<div class="navbar-header" style="margin-left:0%; font-weight: bold;">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1" >
						<nav class="link-effect-14" id="link-effect-14">
							<ul class="nav navbar-nav" style=" margin-left:85%;">
								<!-- <li class="active"><a href="index.jsp"><span>Home</span></a></li> -->
							      
	<li style="margin-right:10px;"><a href="../card.do?command=getAllCards" style="padding:0px;width:100%; margin:15px 0px 0px 0px; padding-top:3px;"><span>청첩장보기</span></a></li>
	<li style="margin-bottom:5px;" class="lnb_icon5"><a href="javascript:logout()" style="padding:0px;width:100%; margin:15px 0px 0px 0px; padding-bottom:5px;"><span class="glyphicon glyphicon-log-in" > 로그아웃</span></a></li>
...
<div class="ui-grid-a contents">
		...
		<img src="img/preview_mobile2.png" alt="미리보기화면" style="width: 370px; height: 740px; margin-left:40%;margin-top:5%;">
				...
				<div class="look_input" style="margin-left:40.5%; margin-top:5%;">
					...
					<iframe src="${initParam.root}/weddingCard/preview/preview.jsp" name="left_skin_preview_mobile" id="left_skin_preview_mobile" style="width: 320px; height: 570px;" scrolling="auto" > </iframe>
				</div>
         ...
         <div class="md-content">
            <div data-role="page" id="skin_page" data-url="skin_page" tabindex="0" class="ui-page ui-page-theme-a ui-page-active">
               <div class="look_input" style="width:90%; height: 80%; margin-left:4%; ">
                  <iframe src="${initParam.root}/weddingCard/preview/preview.jsp" name="left_skin_preview_pc" id="left_skin_preview_pc" style="" scrolling="auto" > </iframe>
               </div>
	...
	<!-- <form action="./card.do" method="post" id="weddingCard_form"
		...
		<div id="tabs" style="width: 25%; margin-left: 70%;">
			<ul>
