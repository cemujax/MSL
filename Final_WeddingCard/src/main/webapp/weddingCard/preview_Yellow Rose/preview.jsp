...
<style>
	...
	.banner {
     background: url(${initParam.root}img/YellowRose.png)no-repeat -170px 0px; 
				 ...
				 <div class="bride"><!-- 신부 신랑 -->
				 	<c:choose>
				 		<c:when test="${param.imgBride == ''  }">
				 			<img src="img/bride2.png" class="img-responsive" alt="">
				 		</c:when>
				 		<c:otherwise>
				 ...
				 <div class="groom">
				 	<c:choose>
				 		<c:when test="${param.imgGroom == '' }">
				 			<img src="img/groom2.png" class="img-responsive" alt="">
				 		</c:when>
				 		<c:otherwise>
	   ...
	   <div class="welcome">
		    <div class="container">
				<div class="welcome-top">
				    <img src="img/mid2.png" class="img-responsive" alt="">
					 <h2>초대글</h2>
