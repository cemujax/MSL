		...
		<div id="content" class="site-content">
			<div class="subhead"
				...
				<div class="backstretch"
					style="">
		<!-- left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 486px; width: 1349px; z-index: -999998; position: absolute; -->
					<img
						src="images/13.jpg"
						style="">
	<!-- position: absolute; margin: 0px; padding: 0px; 
						border: none; width: 1349px; height: 898.386px; 
						max-height: none; max-width: none; z-index: -999999; 
						left: 0px; top: -206.193px; -->
