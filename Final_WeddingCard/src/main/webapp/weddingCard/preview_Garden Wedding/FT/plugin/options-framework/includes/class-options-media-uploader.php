...
class FT_OP_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'ft_op_media_scripts' ) );
	}
	 ...
	 */
	function ft_op_media_scripts( $hook ) {

		$menu = FT_OP_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', get_template_directory_uri() . '/FT/plugin/options-framework/js/media-uploader.js', array( 'jquery' ), FT_OP::VERSION );
		wp_enqueue_script( 'of-media-uploader' );
		wp_localize_script( 'of-media-uploader', 'ft_op_l10n', array(
