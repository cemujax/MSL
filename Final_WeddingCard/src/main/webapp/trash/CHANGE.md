...
### Additions
1. The plugin now offers an option to display initial preview of img/text/other files. This is useful
   for record update scenarios. This can be a single image/file or an array of img/files.
