...
<jsp:param value='초대글입니다.<br>축하하러오세요' name='cardContext'/>
<jsp:param value='2016-07-28' name='cardDate'/>
<jsp:param value='12' name='hour'/>
<jsp:param value='00' name='min'/>
<jsp:param value='AM' name='ampm'/>
<jsp:param value='14' name='dDay'/>
<jsp:param value='웨딩' name='hallName'/>
...
<jsp:param value='test_Pink3' name='url'/>
<jsp:param value='1397' name='cardNo'/>
