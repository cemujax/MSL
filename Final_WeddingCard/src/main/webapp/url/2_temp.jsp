...
<jsp:param value='ㅇㅇㅇㅇㅇ' name='groomName'/>
<jsp:param value='01088888888' name='groomTel'/>
<jsp:param value='ㄴㄴㄴㄴ' name='brideName'/>
<jsp:param value='01099999999' name='brideTel'/>
<jsp:param value='dwadwadad' name='cardContext'/>
...
<jsp:param value='2_temp' name='url'/>
<jsp:param value='1317' name='cardNo'/>
<jsp:param value='15.jpg' name='imgSrc'/>
<jsp:param value='02.jpg' name='imgGroom'/>
<jsp:param value='01.jpg' name='imgBride'/>
</jsp:include>
</body>
</html>
