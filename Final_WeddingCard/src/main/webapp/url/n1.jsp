...
<jsp:param value='adsfadsf' name='groomName'/>
<jsp:param value='11111' name='groomTel'/>
<jsp:param value='sdfsdfs' name='brideName'/>
<jsp:param value='2222' name='brideTel'/>
<jsp:param value='asdfsdf' name='cardContext'/>
...
<jsp:param value='n1' name='url'/>
<jsp:param value='1240' name='cardNo'/>
