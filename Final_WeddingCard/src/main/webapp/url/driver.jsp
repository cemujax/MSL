...
<jsp:param value='ddddd' name='cardContext'/>
<jsp:param value='2016-06-29' name='cardDate'/>
<jsp:param value='22' name='hour'/>
<jsp:param value='00' name='min'/>
<jsp:param value='PM' name='ampm'/>
<jsp:param value='1' name='dDay'/>
<jsp:param value='ddddd' name='hallName'/>
...
<jsp:param value='driver' name='url'/>
<jsp:param value='null' name='imgSrc'/>
<jsp:param value='1212' name='cardNo'/>
</jsp:include>
</body>
</html>
