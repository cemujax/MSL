					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="bridecol">
									<div class="bridepic">
										<img src="images/01.jpg" alt="bride">
									</div>
		...
		<div class="footer-widget-section">
              <div class="container">
		               ...
		               <input type="hidden" id="wedding_pname" value="웨딩홀">
						...
						url(&quot;http://i1.daumcdn.net/dmaps/apis/cursor/openhand.cur.ico&quot;), 
						default;"><div style="position: absolute;">
						<div style="position: absolute; z-index: 1; left: 0px; top: 0px;">
						<img src="http://map3.daumcdn.net/map_2d/165fbd/L4/107/367.png" alt=""
...
/* ]]> */
	...
	jQuery(".subhead").backstretch("images/013.jpg");
