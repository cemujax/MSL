							...
							<div class="col-md-6">
								...
								<div class="bridecol">
									...
									<div class="brideinfo">
										...
										<p style="color:#000;"><i class="glyphicon glyphicon-earphone">${param.brideTel}</i></p>
									</div>
							...
							<div class="col-md-6">
								<div class="groomcol">
									...
									<div class="groominfo">
										...
										<p style="color:#000;"><i class="glyphicon glyphicon-earphone">${param.groomTel}</i></p>
									</div>
								</div>
							</div>
