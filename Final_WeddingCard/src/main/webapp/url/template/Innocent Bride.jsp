					...
					function() {
						...
						$
								.ajax({
									type : "get",
									url : "../card.do",
									data : "command=getAllCardComments&&cardNo="
											+ '${param.cardNo}',
									dataType : "json",
											...
											$('.guestBook')
													.append(
															"<div class='pricingtable pricing_free'><ul class='pricing_iconlist iconset_free'>"
																	+ "<li style='background-color:#f69aca; font-size:15px; border-radius: 10px;'><font style='color: black;'>"
																	+ "작성자"
																	+ "&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;"
																	+ commentList[i].guest
																	+ "</font><br>"
																	+ "<font style='float:right;'>"
																	+ commentList[i].writeDate
																	+ "</font></li>"
																	+ "<li style='font-size: 15px; margin-top:20px;'><span class='user'></span><font>"
