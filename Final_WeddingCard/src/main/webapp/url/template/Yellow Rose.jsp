...
.banner {
	background: url(${initParam.root}img/template_YellowRose.png) no-repeat 0px 0px;
				...
				<div class="bride">
					...
					<c:choose>
						<c:when test="${param.imgBride == ''  }">
							<img src="${initParam.root}img/bride2.png" class="img-responsive" alt="">
						</c:when>
						<c:otherwise>
				...
				<div class="groom">
					<c:choose>
						<c:when test="${param.imgGroom == '' }">
							<img src="${initParam.root}img/groom2.png" class="img-responsive" alt="">
						</c:when>
						<c:otherwise>
	...
	<div class="welcome">
		<div class="container">
			<div class="welcome-top">
				<img src="${initParam.root}img/mid2.png" class="img-responsive" alt="">
				<h2>초대글</h2>
