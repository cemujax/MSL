...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="${initParam.root}weddingCard/preview_${param.templateName}/css/bootstrap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="${initParam.root}weddingCard/preview_${param.templateName}/css/style.css" type="text/css">
	<link href="${initParam.root}weddingCard/preview_${param.templateName}/css/lightbox.css" rel="stylesheet">
...
.header-top {
	...
	.backg {
     background: url("${initParam.root}weddingCard/preview_${param.templateName}/img/wedding_01.png") center top / cover no-repeat;
...
#kakao-link-btn img
	...
	.backg {
     background: url("${initParam.root}weddingCard/preview_${param.templateName}/img/wedding_01.png") no-repeat -420px 0px;
	background-size:cover;
	}
	...
	.portfolio-text
{
	...
	.backg {
        background: url("${initParam.root}weddingCard/preview_${param.templateName}/img//wedding_01.png") no-repeat -370px 0px;
    background-size: cover;
...
<div class="container-fluid main" id="page-top">
	<div class="row">
			...
			<div class="col-md-12 backg">
			     		 <div class="container">
			                 <script defer src="${initParam.root}weddingCard/preview_${param.templateName}/js/jquery.flexslider.js"></script>
			      		</div>
...
<script type='text/javascript'>
  ...
  //]]>
    ...
    <script src="${initParam.root}weddingCard/preview_${param.templateName}/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="${initParam.root}weddingCard/preview_${param.templateName}/js/jquery.countTo.js"></script>
    <script type="text/javascript" src="${initParam.root}weddingCard/preview_${param.templateName}/js/jquery.waypoints.min.js"></script>
   <!--  <script src="https://maps.googleapis.com/maps/api/js"></script> -->
    <script src="${initParam.root}weddingCard/preview_${param.templateName}/js/lightbox.min.js"></script>
  <!--   <script>
      function initialize() {
