...
<div class="form test">
      ...
      <div class="tab-content">
        ...
        <div id="signup">   
          ...
          <form action="${initParam.root }admin.do" method="post">
          <input type="hidden" name="command" value="executeUpdate">
 ...
 <%--            <label>${member_id}</label> --%>
            <input type="hidden" name="member_id" value="${member_id}"></hidden>
          </div>
